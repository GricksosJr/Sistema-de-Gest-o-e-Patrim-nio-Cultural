...
<body>
    ...
    <div class="container">
        ...
        <div class="admin-features">
            <div class="feature-card users" onclick="window.location.href='gestao_usuarios.php'" style="cursor: pointer;">
                <div class="feature-icon">👥</div>
                <h3>Gestão de Usuários</h3>
                <p>Gerir contas de administradores e funcionários, definir permissões e controlar acessos ao sistema.</p>
                <a href="gestao_usuarios.php" class="btn">🚀 Acessar Agora</a>
            </div>

            <div class="feature-card patrimony" onclick="window.location.href='gestao_patrimonio.php'" style="cursor: pointer;">
                ...
                <a href="gestao_patrimonio.php" class="btn btn-patrimony">🏛️ Acessar Agora</a>
            </div>
            ...
            <div class="feature-card reports">
                ...
                <a href="relatorios.php" class="btn warning">📊 Acessar Agora</a>
            </div>
            ...
            <div class="feature-card settings">
                ...
                <p>Configurar parâmetros gerais do sistema, backup de dados e configurações de segurança.</p>
                 <a href="configuracao.php" class="btn warning">📊 Acessar Agora</a>
            </div>
        </div>
    </div>
</body>
